...
<body>
    ...
    <div class="auth-card">
        <div class="d-flex flex-column align-items-center text-center mb-4">
            ...
            <p class="small text-muted mb-0">Kelola keuangan pribadi Anda secara mandiri</p>
        </div>
        ...
        <form action="{{ route('register.post') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <span class="input-group-text bg-transparent text-muted" style="border-color: var(--border-color);"><i class="bi bi-person"></i></span>
            ...
            <div class="mb-3">
                <label class="form-label">Kata Sandi (minimal 6 karakter)</label>
                <div class="input-group">
            ...
            <div class="mb-4">
                ...
                <div class="input-group">
                    <span class="input-group-text bg-transparent text-muted" style="border-color: var(--border-color);"><i class="bi bi-lock-fill"></i></span>
        ...
        <div class="text-center small text-muted">
            Sudah punya akun? <a href="{{ route('login') }}" class="fw-semibold text-primary text-decoration-none">Masuk di sini</a>
        </div>
    </div>
